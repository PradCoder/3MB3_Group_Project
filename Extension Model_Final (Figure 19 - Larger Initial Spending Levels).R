...
# Extension Model
# With Logistic Terms
# Larger initial spending conditions
#####################################
...
#Figure 19: Decay to Equilibrium
...
ggplot(soln2) +
  ...
  annotate("text",
           x = max(t_vals) * 0.7,
           y = (eq_model2$p_star + eq_model2$g_star)/1.8,
           label = paste0("(p*, g*) = (",
           ...
           fontface = "italic") +
  labs(
    title = "Extension Model: Decay to Equilibrium",
    subtitle = "Initial conditions: p(0) = 100, g(0) = 120",
    x = "Time",
    y = "Military Spending",
    colour = "Country",
