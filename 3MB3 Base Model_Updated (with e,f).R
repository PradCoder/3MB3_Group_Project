...
#Model 1 - Condition: cd = ab, (e> 0 f< 0)
model1_diff_b <- arms_model(t_vals, arms, a = 0.4, b = 0.3, c = 0.6, d = 0.2, e=e, f=-f)
...
soln1_neg <- data.frame(
  time = t_vals,
  purple = model1_diff_b[1,],
  green = model1_diff_b[2,]
)
...
#Model 2 - Condition: cd < ab , (e < 0, f > 0)
model2_diff_b <- arms_model(t_vals, arms, a = 1.2, b = 1.1, c = 0.3, d = 0.3, -e, f)
#Plot Model 2
soln2 <- data.frame(
  time = t_vals,
  purple = model2_diff[1,],
